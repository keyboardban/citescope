...
`tests/test_confounders.py`).
**88 pytest tests pass; AppTest renders both modes incl. the regression + sensitivity + confounder sections; verified end-to-end on a real 1,270-source ChatGPT audit.** Untracked reference files
